...
public class CodeGenerator {
    ...
    private static final String parentPackageName = "me.zzy";
    private static final String author = "zzy";
    private static final String outPath = projectPath + "/src/main/java/";
    private static final String mapperPath = projectPath + "/src/main/java/me/zzy/mapper/xml/";
